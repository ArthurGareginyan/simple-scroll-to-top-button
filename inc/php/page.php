 ...
 */
function spacexchimp_p008_render_submenu_page() {
    ...
    // Call messages
    spacexchimp_p008_hello_message();
    spacexchimp_p008_error_message();
    ...
    <div class="wrap">
        ...
        <div id="poststuff" class="metabox-holder has-right-sidebar">
            ...
            <div class="tab-page fade active in" id="tab-core">
                <!-- INCLUDE SIDEBAR -->
                <?php require_once( SPACEXCHIMP_P008_PATH . 'inc/php/sidebar.php' ); ?>
                <!-- INCLUDE SETTINGS -->
                <?php require_once( SPACEXCHIMP_P008_PATH . 'inc/php/settings.php' ); ?>
            </div>
            <!-- END-TAB 1 -->
                ...
                <div class="postbox">
                    ...
                    <div class="inside">
                        ...
                        <div class="answer-<?php echo $i; $i++ ?>">
                            ...
                            <?php _e( 'Enjoy your fancy "Scroll to Top" button.', $text ); ?>
                            <?php _e( 'It\'s that simple!', $text ); ?>
                        </div>

                        <div class="question-<?php echo $i; ?>">
                            <?php _e( 'Is it possible to use different buttons/arrows?', $text ); ?>
                        </div>
                        <div class="answer-<?php echo $i; $i++ ?>">
                            <?php _e( 'This plugin comes with the FontAwesome iconic font.', $text ); ?>
                            <?php _e( 'Now you can customize the button style using and combining 10 symbols and 4 backgrounds from FontAwesome library, in result you have 40 variations of buttons.', $text ); ?>
                            <?php _e( 'You can change the size of button, color (unlimited) of background, color (unlimited) of symbol and etc.', $text ); ?>
                            <?php _e( 'A future version may include more buttons, and/or the option to upload your own button graphics.', $text ); ?>
                        </div>
