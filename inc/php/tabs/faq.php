                ...
                <div class="postbox">
                    ...
                    <div class="inside">
                        ...
                        <div class="answer-<?php echo $i; $i++ ?>">
                            ...
                            <?php _e( 'Enjoy your fancy "Scroll to Top" button.', $plugin['text'] ); ?>
                            <?php _e( 'It\'s that simple!', $plugin['text'] ); ?>
                        </div>

                        <div class="question-<?php echo $i; ?>">
                            <?php _e( 'Is it possible to use different buttons/arrows?', $plugin['text'] ); ?>
                        </div>
                        <div class="answer-<?php echo $i; $i++ ?>">
                            <?php _e( 'This plugin comes with the FontAwesome iconic font.', $plugin['text'] ); ?>
                            <?php _e( 'Now you can customize the button style using and combining 10 symbols and 4 backgrounds from FontAwesome library, in result you have 40 variations of buttons.', $plugin['text'] ); ?>
                            <?php _e( 'You can change the size of button, color (unlimited) of background, color (unlimited) of symbol and etc.', $plugin['text'] ); ?>
                            <?php _e( 'A future version may include more buttons, and/or the option to upload your own button graphics.', $plugin['text'] ); ?>
                        </div>
