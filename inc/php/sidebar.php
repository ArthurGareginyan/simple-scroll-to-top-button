    ...
    <div class="inner-sidebar">
        <div id="side-sortables" class="meta-box-sortabless ui-sortable">
            ...
            <div class="postbox banner">
                ...
                <div class="inside">
                    <a href="https://www.spacexchimp.com/" target="_blank">
                        <img src="<?php echo SPACEXCHIMP_P008_URL . 'inc/img/spacexchimp-logo.png'; ?>" alt="Space X-Chimp">
                    </a>
                </div>
            </div>
            ...
            <div class="postbox about">
                ...
                <div class="inside">
                    <p><?php _e( 'This plugin gives you the ability to easily and safely add a "Scroll to Top" button to your WordPress website.', $text ); ?></p>
                </div>
            </div>
