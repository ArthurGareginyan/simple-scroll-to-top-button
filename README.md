...
Thank you for considering contributing to the plugin "Simple Scroll to Top Button"! The contribution guide can be found in the [CONTRIBUTING.md](https://github.com/ArthurGareginyan/simple-scroll-to-top-button/blob/master/CONTRIBUTING.md).
